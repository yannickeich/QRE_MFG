...
def plot():
    ...
    for game in games:
        ...
        ax1.set_yticks([1e-4,1e-10])
        ax2.set_yticks([1e-4, 1e-10])
        ax3.set_yticks([1e-4, 1e-10])
        ax4.set_yticks([1e-4, 1e-10])
    ...
    plt.savefig(f'./figures/GFP.pdf', bbox_inches='tight', transparent=True, pad_inches=0)
